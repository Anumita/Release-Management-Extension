    ...
    c.onReleaseChanged(function (release) {
        ...
        $('.container').click(function (event) {
            if (event.target != this) {
                ...
                for (var l in arr_obj) {
                    var temp_obj = arr_obj[l];
                    if ((event.target.id == "pre" + temp_obj.id) || (event.target.id == "pos" + temp_obj.id)) {
                        if (event.target.id[1] == 'r') {
                            alert(document.getElementsByClassName("rich-content-tooltip popup-content-control").id);
                            document.getElementById("pre" + temp_obj.id).style.backgroundColor = "green";
                        }
                        else {
                            alert('post');
                            document.getElementById("pos" + temp_obj.id).style.backgroundColor = "green";
                        }
                    }
                }
